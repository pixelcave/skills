...
Also supports the shared animation props (`animated`, `trigger`) and `className`, all documented in `SKILL.md`. Every prop is optional and falls back to a sensible default.
